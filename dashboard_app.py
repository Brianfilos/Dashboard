...
if excel_file is not None:
    ...
    if not registro_servicios_bancarios.empty:
        ...
        cruce_servicios['Nota'] = f"Cruce parcial con diferencia de {diferencia_servicios:.2f}. Registros CSV usados: {df_registros_usados_csv_servicios.shape[0]}"

        # Marcar como cruzado en el Excel y eliminar de los no cruzados del CSV
        ...
        # Mostrar el resultado del cruce de servicios
